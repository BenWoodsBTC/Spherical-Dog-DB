...
const OPENING_SCENE_ID = 'recrFBMR5Q2BDRKmN';
...
function getScene(record_id) {
  ...
  const key = 'keyItEIXWRE3rKzco';
  const base_url = 'app6RmVjsvHDPlRps'; 
  ...
  $.ajax({ url: url, type: 'GET' })
    .done(function (data) {
	  ...
	  if (data.fields.special) {
		switch(special) {
		  case "M11":
			window.location.href = "./mastermind-web-master/index.html";
			break;
		  default:
			// code block
		}
